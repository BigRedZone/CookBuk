  ...
  render() {
    ...
    return (
      <div id="recipe-container">
        ...
        <div>
          <button type="button" className="recipe-start-button" onClick={() => this.changeView('steps')}>Start</button>
          <br />
          <br />
          <button type="button" className="recipe-edit-button" onClick={() => this.changeView('edit')}>Edit</button>
        </div>
      </div>
    );
  }
